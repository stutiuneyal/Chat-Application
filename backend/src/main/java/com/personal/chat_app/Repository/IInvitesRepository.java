...
public interface IInvitesRepository extends MongoRepository<Invites, String> {
    ...
    List<Invites> findByToUserIdAndStatusOrderBySentAtDesc(String toUserId, Status status);

    Optional<Invites> findByIdAndToUserId(String id, String toUserId);

    boolean existsByRoomIdAndToUserIdAndStatus(String roomId, String toUserId, Status status);
